...
### 4. Deploy
Place the `teachers-bank-api-v4/` folder inside your Apache web root (e.g., `/var/www/html/`).
...
```
NEXT_PUBLIC_API_BASE=http://localhost/teachers-bank-api-v4
```
